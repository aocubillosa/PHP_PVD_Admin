...
<div class="modal-header">
	...
	<h4 class="modal-title" id="exampleModalLabel">Formulario de Elemento
...
<div class="modal-body">
	...
	<form name="form" id="form" role="form" method="post" >
		<input type="hidden" id="hddId" name="hddId" value="<?php echo $information?$information[0]["id_elemento"]:""; ?>"/>
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group text-left">
					<label class="control-label" for="elemento">Elemento: *</label>
					<input type="text" id="elemento" name="elemento" class="form-control" value="<?php echo $information?$information[0]["elemento"]:""; ?>" placeholder="Elemento" required >
				</div>
			</div>
		</div>
