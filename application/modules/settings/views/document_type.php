	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-list"></i> Lista de Tipo de Documento
					<div class="pull-right">
						<div class="btn-group">
							<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal" id="x">
								Adicionar Tipo Documento <span class="fa fa-plus" aria-hidden="true"></span>
							</button>
						</div>
					</div>
				</div>
				<div class="panel-body">
					...
					<table width="100%" class="table table-striped table-bordered table-hover small" id="dataTables">
						...
						<tbody>
						<?php
							foreach ($tipoDoc as $lista):
								echo "<tr>";
								echo "<td>" . $lista['tipo_documento'] . "</td>";
								echo "<td class='text-center'>";
								?>
									<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal" id="<?php echo $lista['id_tipo_documento']; ?>" >
										Editar <span class="fa fa-pencil-square-o" aria-hidden="true">
									</button>&nbsp;&nbsp;&nbsp;
									<button type="button" id="<?php echo $lista['id_tipo_documento']; ?>" class='btn btn-danger btn-xs'>
