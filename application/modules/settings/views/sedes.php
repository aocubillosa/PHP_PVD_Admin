		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<i class="fa fa-university fa-fw"></i> SEDES
					</h4>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-list"></i> Lista de Sedes
					<div class="pull-right">
						<div class="btn-group">
							<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal" id="x">
								Adicionar Sede <span class="fa fa-plus" aria-hidden="true"></span>
							</button>
						</div>
					</div>
				</div>
						...
						<?php
							foreach ($sedes as $lista):
								...
								?>
									...
									<button type="button" id="<?php echo $lista['id_sede']; ?>" class='btn btn-danger btn-xs'>
