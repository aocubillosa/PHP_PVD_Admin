		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					...
					<i class="fa fa-registered fa-fw"></i> MARCAS
					</h4>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-list"></i> Lista de Marcas
					<div class="pull-right">
						<div class="btn-group">
							<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal" id="x">
								Adicionar Marca <span class="fa fa-plus" aria-hidden="true"></span>
							</button>
						</div>
					</div>
				</div>
					...
					<table width="100%" class="table table-striped table-bordered table-hover small" id="dataTables">
						...
						<?php
							foreach ($marcas as $lista):
								...
								?>
									<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal" id="<?php echo $lista['id_marca']; ?>" >
										Editar <span class="fa fa-pencil-square-o" aria-hidden="true">
									</button>&nbsp;&nbsp;&nbsp;
									<button type="button" id="<?php echo $lista['id_marca']; ?>" class='btn btn-danger btn-xs'>
