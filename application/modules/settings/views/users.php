	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<i class="fa fa-list"></i> LISTA DE USUARIOS DEL SISTEMA
					<div class="pull-right">
						<div class="btn-group">
							<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal" id="x">
								Adicionar Usuario <span class="fa fa-plus" aria-hidden="true"></span>
							</button>
						</div>
					</div>
				</div>
					...
					<table width="100%" class="table table-striped table-bordered table-hover small" id="dataTables">
						<thead>
							<tr>
								...
								<th class="text-center">Punto Vive Digital</th>
						...
						<?php
							foreach ($info as $lista):
								...
								echo "<td class='text-right'>" . $lista["movil"] . "</td>";
								...
								echo "<td class='text-center'>";
								?>
									<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#modal" id="<?php echo $lista['id_user']; ?>" >Editar <span class="fa fa-pencil-square-o" aria-hidden="true">
									</button>
									<button type="button" id="<?php echo $lista['id_user']; ?>" class="btn btn-warning btn-xs">Contraseña <i class="fa fa-unlock"></i>
									</button>
								<?php
								echo "</td>";
							echo "</tr>";
